 ...
 */
function login() {
    return location.href = "http://localhost:82/page/login.html";
}
function regist() {
    return location.href = "http://localhost:82/page/register.html";
}
...
function search(a) {
    var b = "http://localhost:86/search.html?q=" + encodeURIComponent(document.getElementById(a).value);
