                    ...
                    <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
                        <div class="item_form clearfix">
                            ...
                            <div class="cell p-goods">
                                <div class="p-img">
                                    <a href="http://localhost:89/item/${cart.itemId }.html" target="_blank">
                                        <img clstag="clickcart|keycount|xincart|p-imglistcart" src="${cart.itemImage}"
                                             alt="${cart.itemTitle}" width="52" height="52">
                                    </a>
                                </div>
                                <div class="p-name">
                                    <a href="http://localhost:89/item/${cart.itemId }.html" clstag="clickcart|keycount|xincart|productnamelink"
                            ...
                            <div class="cell p-quantity" for-stock="for-stock-11345721">
                                <div class="quantity-form" data-bind="">
                                    ...
                                    <input type="text" class="quantity-text" itemPrice="${cart.itemPrice}"
                            ...
                            <div class="cell p-remove"><a id="remove-11345721-1" data-more="removed-87.20-1"
                                                          ...
                                                          class="cart-remove" href="/cart/delete/${cart.itemId}.html">删除</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
            ...
            <div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;">
              ...
              <span class="column t-checkbox form">
                  ...
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://localhost:8092/order/order-cart.html"
